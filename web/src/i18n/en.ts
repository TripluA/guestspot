export default {
  ...
  registerVerifyEmail: 'Please check your email to verify your address. After verification, an administrator will review your account.',
  registerApprovalNote: 'An administrator will review your account shortly.',
  registerLogin: 'Already have an account?',
  registerSpotOptional: 'Optional',
  ...
  profilePasswordSent: 'We sent you an email with a link to change your password.',
  ...
  passwordResetRequest: 'Send reset email',
  passwordResetNewPassword: 'New password',
  passwordResetSetPassword: 'Set new password',
  passwordResetEmailSent: 'Check your email for a password reset link.',
  passwordResetSuccess: 'Password reset successfully',
  passwordResetSuccessMessage: 'Your password has been reset. You can now sign in.',
  passwordResetCheckEmail: 'If the email exists in our system, a reset link has been sent.',
  sending: 'Sending…',
  ...
  adminAnnounceTitle: 'New announcement',
  adminAnnounceMessage: 'Message',
  adminAnnounceTarget: 'Send to',
  adminAnnounceBuilding: 'Building',
  adminAnnounceAll: 'All buildings',
  adminAnnounceDismiss: 'Dismiss',
